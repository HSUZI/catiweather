...
public class CatiWeatherDB {
    ...
    /**
     * 获取CatiWeatherDB实例(同步方法)
     * */
    public synchronized static CatiWeatherDB getInstance(Context context) {
        if(catiWeatherDB == null) {
            catiWeatherDB = new CatiWeatherDB(context);
        }
        return catiWeatherDB;
    }
